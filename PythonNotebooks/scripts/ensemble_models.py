...
from tensorflow.keras.layers import Conv1D, Dense, MaxPooling1D, Flatten, Input, Dense, Dropout, LeakyReLU, AveragePooling1D, BatchNormalization, ELU
...
def define_stacked_model(members, opt, ens_pth, in_dict):
...
def fit_stacked_modelimg(model, input_train, input_test, n_epochs,  es, y_train, y_test):
    # prepare input data
